...
class CausalGraphAnalyzer:
    ...
    @staticmethod
    def _path_based_causal_strength(G: nx.DiGraph, source: str, target: str) -> float:
        """
...
class StrategicDecalogoIntegrator:
    ...
    @staticmethod
    def _calculate_dimension_kpi(question_results: Dict[str, Any]) -> float:
        """
    ...
    def _calculate_performance_metrics(
        results: Dict[str, Any], elapsed_time: float
    ) -> Dict[str, Any]:
