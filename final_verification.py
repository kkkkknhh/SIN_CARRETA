...
print("✓ CHECK 1: Number of entries")
...
print("✓ CHECK 2: Sum of all weights")
print(f"  Result: {total:.15f}")
print("  Expected: 1.000000000000000")
...
print("✓ CHECK 3: Each weight equals 0.003333333333333333")
...
print("✓ CHECK 4: ID pattern P{{point}}-D{{dimension}}-Q{{question}}")
print("  Pattern: P{{1-10}}-D{{1-6}}-Q{{1-30}}")
...
print("✓ CHECK 5: Questions per thematic point (should be 30 each)")
...
print("✓ CHECK 6: Questions per dimension (should be 50 each)")
...
print("✓ CHECK 7: Question number ranges per dimension")
dimension_ranges = {
    'D1': list(range(1, 6)),
    'D2': list(range(6, 11)),
    'D3': list(range(11, 16)),
