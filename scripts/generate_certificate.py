...
class CertificateGenerator:
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                key_packages = {
                    ...
                    'sentence-transformers', 'spacy', 'pandas', 'networkx',
                    'pydantic', 'jsonschema', 'fastapi', 'pytest',
                }
    ...
    def generate_certificate(self) -> Dict[str, Any]:
        ...
        all_passed = all(
            ...
            for check in self.test_results.values()
        )
...
"""
        ...
        if 'git_commit' in certificate['environment']:
            md += f"- **Git Commit**: `{certificate['environment']['git_commit'][:8]}`\n"
