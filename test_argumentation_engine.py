...
def create_target_evidence(confidence: float = 0.80) -> StructuredEvidence:
    ...
    return create_test_evidence(
        ...
        content={
            "target_text": "meta 2025: 80% cobertura",
            "quantitative": True
        },
        confidence=confidence
    )
...
class TestLogicalCoherenceValidator(unittest.TestCase):
    ...
    def test_valid_argument_scores_high(self):
        ...
        toulmin = ToulminArgument(
            ...
            evidence_sources=["feasibility_scorer", "monetary_detector", "responsibility_detector"],
            confidence_lower=0.75,
            confidence_upper=0.95
        )
        ...
        self.assertGreaterEqual(score, 0.85, 
                                f"Valid argument should score ≥0.85, got {score:.2f}")
    ...
    def test_circular_reasoning_detected(self):
        ...
        self.assertLess(score, 1.0, 
                       "Circular reasoning should reduce score")
    ...
    def test_weak_warrant_detected(self):
        ...
        score = self.validator.validate(toulmin)
        self.assertLess(score, 1.0,
                       "Weak warrant should reduce score")
    ...
    def test_insufficient_backing_penalized(self):
        ...
        toulmin = ToulminArgument(
            ...
            backing=["Additional source A provides independent corroboration with specific details", 
                     "Secondary source B confirms the assessment through quantitative analysis"],  # Sufficient backing
        ...
        self.assertGreaterEqual(score, 0.85,
                               f"Well-formed argument should score ≥0.85, got {score:.2f}")
...
class TestAcademicWritingAnalyzer(unittest.TestCase):
    ...
    def test_precision_detects_vague_language(self):
        ...
        self.assertLess(score, 0.80,
                       f"Vague language should score <0.80, got {score:.2f}")
    ...
    def test_precision_rewards_precise_language(self):
        ...
        self.assertGreater(score, 0.85,
                          f"Precise language should score >0.85, got {score:.2f}")
    ...
    def test_overall_quality_integrates_dimensions(self):
        ...
        self.assertGreaterEqual(scores['overall_score'], 0.80,
    ...
    def test_coherence_checks_transitions(self):
        ...
        self.assertGreater(score_with, score_without,
                          "Paragraphs with transitions should score higher")
...
class TestDoctoralArgumentationEngine(unittest.TestCase):
    ...
    def test_generates_three_paragraphs(self):
        ...
        self.assertEqual(len(result['argument_paragraphs']), 3,
                        "Must generate exactly 3 paragraphs")
    ...
    def test_toulmin_structure_present(self):
        ...
        required_keys = ['claim', 'ground', 'warrant', 'backing', 'rebuttal', 'qualifier']
    ...
    def test_multi_source_synthesis(self):
        ...
        evidence = [
            ...
            create_monetary_evidence(0.85),
            create_target_evidence(0.80),
            create_test_evidence("responsibility_detector", "responsibility", {"entity": "Municipality"}, 0.75)
        ]
        ...
        self.assertGreaterEqual(len(synth_map['all_sources']), 3,
                               "Should synthesize ≥3 sources")
    ...
    def test_academic_quality_validated(self):
        ...
        self.assertGreaterEqual(quality['overall_score'], 0.80,
    ...
    def test_deterministic_output(self):
        ...
        self.assertEqual(result1['argument_paragraphs'], result2['argument_paragraphs'],
                        "Same evidence should produce identical arguments")
        
        self.assertEqual(result1['toulmin_structure']['claim'], 
    ...
    def test_evidence_ranking_prioritizes_quality(self):
        ...
        self.assertEqual(ranked[0].confidence, 0.95,
    ...
    def test_claim_strength_matches_score(self):
        ...
        self.assertIn("fully", claim_high.lower(),
                     "High score should generate 'fully' claim")
        
        # Test medium score
        claim_med = self.engine._generate_claim("D1-Q1", 1.5, evidence[0])
        self.assertIn("partially", claim_med.lower(),
                     "Medium score should generate 'partially' claim")
        
        # Test low score
        claim_low = self.engine._generate_claim("D1-Q1", 0.5, evidence[0])
        self.assertIn("does not", claim_low.lower(),
                     "Low score should generate 'does not' claim")
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_empty_evidence_content(self):
        ...
        try:
            ...
            self.fail(f"Should handle minimal evidence content gracefully, but raised: {e}")
...
class TestAntiPatternDetection(unittest.TestCase):
    ...
    def test_rejects_vague_quantifiers(self):
        ...
        self.assertLess(score, 0.60,
                       f"Vague quantifiers should score <0.60, got {score:.2f}")
    ...
    def test_requires_explicit_connectives(self):
        ...
        toulmin_strong = ToulminArgument(
            ...
            backing=["Additional source A provides corroboration", "Independent source B confirms"],
...
class TestIntegrationScenarios(unittest.TestCase):
    ...
    def test_full_argument_generation_high_quality(self):
        ...
        evidence = [
            ...
            create_test_evidence("responsibility_detector", "institutional_responsibility",
                                {"entity": "Municipality", "explicit": True}, 0.82)
        ]
        ...
        self.assertEqual(len(result['argument_paragraphs']), 3)
        self.assertGreaterEqual(result['logical_coherence_score'], 0.85)
        self.assertGreaterEqual(result['academic_quality_scores']['overall_score'], 0.80)
        self.assertLessEqual(result['confidence_alignment_error'], 0.05)
    ...
    def test_full_argument_generation_moderate_quality(self):
        ...
        posterior = {
            'posterior_mean': 0.62,
            'credible_interval_95': (0.50, 0.74)
        }
        ...
        self.assertTrue(
            any(term in qualifier_lower for term in ['moderate', 'substantial', 'considerable']),
    ...
    def test_300_questions_scenario(self):
        ...
        question_ids = [f"D{d}-Q{q}" for d in range(1, 7) for q in range(1, 6)]  # 30 questions sample
        ...
        for qid in question_ids[:5]:  # Test first 5
            ...
            try:
                ...
                if (result['logical_coherence_score'] >= 0.85 and 
        ...
        self.assertGreaterEqual(success_count / 5, 0.6,
