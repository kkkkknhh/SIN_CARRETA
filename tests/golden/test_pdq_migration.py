...
GOLDEN_CASES = [
    ...
    (
        ...
        "D3-Q12",
        True,
        "P#-Q# inferred to D3 (Q12 is in 11-15 range)",
    ),
    (
        "P7-Q29",
        {},
        ...
        "D6-Q29",
        True,
        "P#-Q# inferred to D6 (Q29 is in 26-30 range)",
    ),
    ...
    (
        ...
        "D6-Q50",
        True,
        "Edge case: P10 with large Q number",
    ),
    (
        "D1-Q100",
        {"section": "P4"},
...
def run_golden_tests() -> Tuple[int, int]:
    ...
    for i, (
        ...
        try:
            ...
            print(
                f"  ✅ PASS: {normalized} (rubric_key: {rubric_key}, confidence: {confidence:.2f})"
            )
            passed += 1
