...
from teoria_cambio import CausalElement, CausalElementType, TeoriaCambio
...
class TestTeoriaCambioDAGFlow:
    ...
    def test_teoria_cambio_creates_valid_dag():
        ...
        elementos = [
            CausalElement(
                id="A1", text="Capacitación", element_type=CausalElementType.ACTIVITY
            ),
            CausalElement(
                id="P1",
                text="500 capacitados",
    ...
    def test_cache_invalidation_preserves_dag_property():
        ...
        elementos1 = [
            CausalElement(
                id="A1", text="Act 1", element_type=CausalElementType.ACTIVITY
            ),
            CausalElement(
                id="P1",
                text="Prod 1",
