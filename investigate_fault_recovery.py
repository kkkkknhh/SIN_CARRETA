...
class InstrumentedCircuitBreaker(CircuitBreaker):
    ...
    def call(self, func, *args, **kwargs):
        ...
        try:
            ...
            exec_end = time.time()
            self._log_timing(
                "function_execution", exec_start, exec_end, {"status": "success"}
            )
            ...
            call_end = time.time()
            self._log_timing(
                "total_call", call_start, call_end, {"overall_status": "success"}
            )
    ...
    def _transition_to(self, new_state: CircuitState):
        ...
        self._log_timing(
            "state_transition", transition_start, transition_end, transition
        )
