...
def test_feasibility_stage_integration_mocked():
    ...
    test_segments = [
        {"text": "La línea base muestra una tasa de pobreza del 25% actual.", "id": "seg_0"},
        {"text": "La meta es reducir la pobreza hasta el 15% para el año 2025.", "id": "seg_1"},
        {"text": "El objetivo de cobertura educativa es alcanzar el 90% en el 2026.", "id": "seg_2"},
    ]
    ...
    assert evidence_metadata["pattern_detector_source"] == "factibilidad.pattern_detector.PatternDetector"
    assert evidence_metadata["scorer_source"] == "factibilidad.scoring.FactibilidadScorer"
