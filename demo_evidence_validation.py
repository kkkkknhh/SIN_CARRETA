...
def demo_evidence_validation():
    ...
    print(f"Questions Meeting Threshold: {validation_result['questions_meeting_threshold']}")
    print(f"Questions Below Threshold: {len(validation_result['questions_below_threshold'])}")
        ...
        for qid in meeting_threshold[:3]:
            ...
            for source in summary["evidence_sources"]:
                ...
                if source['quality_metrics']:
                    ...
                    print(f"      Quality: P={metrics.get('precision', 0):.2%}, "
    ...
    print(f"Questions with < 3 evidence: {len(validation_result['questions_below_threshold'])} "
