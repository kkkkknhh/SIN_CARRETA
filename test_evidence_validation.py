...
def test_validation_basic():
    ...
    result = registry.validate_evidence_counts(
        all_question_ids=["D1-Q1", "D1-Q2", "D1-Q3"],
    ...
    for qid in ["D1-Q1", "D1-Q2", "D1-Q3"]:
        ...
        print(f"✓ {qid}: Evidence from stages {sorted(summary['stage_contributions'].keys())}")
...
def test_validation_insufficient_evidence():
    ...
    print(f"  D1-Q1: {result['evidence_summary']['D1-Q1']['evidence_count']} evidence (sufficient)")
    print(f"  D1-Q2: {result['evidence_summary']['D1-Q2']['evidence_count']} evidence (insufficient)")
    
    # Check stage information for insufficient question
    d1q2_summary = result["evidence_summary"]["D1-Q2"]
    print(f"  D1-Q2 contributing stages: {sorted(d1q2_summary['stage_contributions'].keys())}")
