...
def test_evaluate_from_evidence_detector_instantiation():
    ...
    source = inspect.getsource(ExtractorEvidenciaIndustrialAvanzado.evaluate_from_evidence)
...
def test_detector_methods_structure():
    ...
    extract_sig = inspect.signature(ExtractorEvidenciaIndustrialAvanzado._extract_dimension_evidence)
    ...
    calc_sig = inspect.signature(ExtractorEvidenciaIndustrialAvanzado._calculate_dimension_score)
